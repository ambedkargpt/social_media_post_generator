...
const USE_CASES = [
  {
    ...
    body: "Use Ambedkar’s speeches on current events to build confidence and win elections.",
  },
  {
    icon: Search,
    title: "Understanding Public Problems",
    body: "AI scans local news and ground realities to reveal voter issues so you always speak real concerns.",
  },
  {
    icon: Zap,
    title: "Real-Time Debate Assistant",
    body: "During live debates, the AI feeds you quick facts, counter-arguments, and data points via a discreet device, ensuring you always have a logical edge.",
  },
  {
    icon: Target,
    title: "Opponent Weakness Finder",
    body: "AI scans opponents’ past speeches, promises, and voting records to highlight inconsistencies and unfulfilled promises, all fact-based.",
  },
];
    ...
    <section id="bheem" className="relative py-8 md:py-10">
      ...
      <div className="relative mx-auto max-w-[1320px] px-6">
        ...
        <h2 className="mx-auto mt-8 max-w-[820px] text-center font-display text-[46px] font-bold leading-[1.05] text-white md:text-[62px]">
          ...
          <br className="hidden md:block" /> and Win With{" "}
        ...
        {/* <p className="mx-auto mt-6 max-w-[760px] text-center text-[15px] leading-7 text-[#a6b9d6]">
          Our AI system connects scholars, creators, engineers, and
          changemakers, automating knowledge access, providing verified
          insights, and transforming information into actionable understanding.
        </p> */}
