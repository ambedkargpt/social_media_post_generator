#!/usr/bin/env bash
# Run on the droplet as root. Creates hot-storage layout (DEPLOYMENT_PLAN.md §6).
set -euo pipefail
...
chown -R "$AMBEDKAR_USER:$AMBEDKAR_USER" /data/artifacts /data/locks /data/transcripts /data/logs /srv/ambedkar
